...
cdrom::Sector::ECC ECC::Generate(cdrom::Sector &sector, bool zero_address)
{
    cdrom::Sector::ECC ecc;

    // Save the address and zero it out
    cdrom::Sector::Header header;
    if(zero_address)
    {
...
cdrom::Sector::ECC ECC::Generate(const uint8_t *data)
{
    cdrom::Sector::ECC ecc;
